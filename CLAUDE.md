...
Stellar Game Studio is a starter kit for building Soroban on-chain games that integrate with Game Hub. It provides a mock Game Hub contract, two example games (Twenty-One and Number Guess), a React frontend, and automated deployment scripts for Stellar testnet.
...
4. **Preserve Game Hub integration** - DO NOT modify the `call_hub_start_game` and `call_hub_end_game` functions
